...
let totalPrice = document.querySelector(".total-fee");
...
function adder(v) {
    if(v===item1){
        ...
        totalPrice.innerHTML = parseFloat(itemPrice1.innerHTML + 148.99).toFixed(2);
    }else{
        counter2 += 1;
...
//         document.querySelector(".itemP1").innerHTML = "100.99";
// }
